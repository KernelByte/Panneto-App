...
public class KeyHelper {
    ...
    private static final String PUBLIC_IV_PERSONAL = "PUBLIC_IV_PERSONAL";
        ...
        if (keyHelper == null) {
            try {
                keyHelper = new KeyHelper(ctx);
                    ...
                    InvalidAlgorithmParameterException | KeyStoreException | CertificateException | IOException e) {
                e.printStackTrace();
            }
        }
        return keyHelper;
    ...
    private void generateEncryptKey(Context ctx) throws NoSuchProviderException, NoSuchAlgorithmException,
    ...
    public KeyHelper(Context ctx) throws NoSuchPaddingException, NoSuchProviderException, NoSuchAlgorithmException,
            InvalidAlgorithmParameterException, KeyStoreException, CertificateException, IOException {
    ...
    private void generateRandomIV(Context ctx){
        ...
        String publicIV = pref.getString(PUBLIC_IV_PERSONAL, null);
    ...
    public String encrypt(Context context, String input) throws NoSuchAlgorithmException, NoSuchPaddingException,
            NoSuchProviderException, BadPaddingException, IllegalBlockSizeException, UnsupportedEncodingException {
        Cipher c;
        SharedPreferences pref = context.getSharedPreferences(SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE);
        String publicIV = pref.getString(PUBLIC_IV_PERSONAL, null);
    ...
    public interface MyConstants {
        String APP_SHAREDPREFS = "KeyPreferences";
    }
}
